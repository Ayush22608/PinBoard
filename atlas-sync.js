...
// Import MongoDB Atlas credentials from config
...
async function syncToAtlas() {
  ...
  try {
    ...
    // Clear existing data
    console.log('Clearing existing posters from MongoDB Atlas...');
    ...
    console.log(`Sync complete. Successfully imported ${successCount} of ${snapshot.size} posters to MongoDB Atlas.`);
